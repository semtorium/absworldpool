...
const COUNTRIES = [
  ...
  { id:  3, name: "Belgium" },       { id:  4, name: "France" },
  { id:  5, name: "Argentina" },     { id:  6, name: "England" },
  { id:  7, name: "Spain" },         { id:  8, name: "Portugal" },
  { id:  9, name: "Netherlands" },   { id: 10, name: "Germany" },
  { id: 11, name: "Uruguay" },       { id: 12, name: "Denmark" },
  { id: 13, name: "Croatia" },       { id: 14, name: "Switzerland" },
  { id: 15, name: "USA" },           { id: 16, name: "Mexico" },
  { id: 17, name: "Senegal" },       { id: 18, name: "Morocco" },
  { id: 19, name: "Japan" },         { id: 20, name: "South Korea" },
  { id: 21, name: "Canada" },        { id: 22, name: "Ecuador" },
  { id: 23, name: "Poland" },        { id: 24, name: "Australia" },
  { id: 25, name: "Serbia" },        { id: 26, name: "Ghana" },
  { id: 27, name: "Cameroon" },      { id: 28, name: "South Africa" },
  { id: 29, name: "Colombia" },      { id: 30, name: "Turkey" },
  { id: 31, name: "Italy" },         { id: 32, name: "Austria" },
  { id: 33, name: "Ukraine" },       { id: 34, name: "Hungary" },
  { id: 35, name: "Norway" },        { id: 36, name: "Sweden" },
  { id: 37, name: "Scotland" },      { id: 38, name: "Greece" },
  { id: 39, name: "Romania" },       { id: 40, name: "Slovakia" },
  { id: 41, name: "Algeria" },       { id: 42, name: "Egypt" },
  { id: 43, name: "Nigeria" },       { id: 44, name: "Ivory Coast" },
  { id: 45, name: "Chile" },         { id: 46, name: "Peru" },
  { id: 47, name: "Venezuela" },     { id: 48, name: "New Zealand" },
];
